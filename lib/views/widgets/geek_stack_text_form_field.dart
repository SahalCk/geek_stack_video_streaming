  ...
  Widget build(BuildContext context) {
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
          ...
          prefixIconColor: const Color.fromARGB(255, 199, 199, 199),
          hintText: hint,
...
class GeekStackPasswordTextFormField extends StatelessWidget {
  final String hint;
  final Icon? prefixIcon;
  final TextEditingController passwordController;

  const GeekStackPasswordTextFormField(
      {super.key,
      required this.hint,
      this.prefixIcon,
